...
;(function (window, document, $, enquire, settings, undefined) {
  ...
  var Breakpoints = {
     ...
     * media query.
     * Give it "all" to register for all breakpoints as they were one.
     * Give it "any" to register for for every breakpoint separetelly.
     *
     * Please, refer to http://wicky.nillia.ms/enquire.js/#api.
     */
    register: function (breakpoint, handler) {
      (breakpoint === 'any' && getBreakpointMachineNames() || [breakpoint]).forEach(function (breakpoint) {
