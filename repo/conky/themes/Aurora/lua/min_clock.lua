...
written by easysid  https://github.com/easysid/conky_configs
...
clock_table = {
        ...
        hour_font = "lato bold",  -- font face for hours
        min_font  = "lato bold",  -- font face for minutes
        day_font  = "lato bold",  -- font face for day and time period
