...
function conky_draw_clock()
	...
	cairo_pattern_add_color_stop_rgba(border_pat,0,1,1,1,0)
	cairo_pattern_add_color_stop_rgba(border_pat,0.3,1,1,1,0.6)
	cairo_pattern_add_color_stop_rgba(border_pat,0.5,1,1,1,0)
	cairo_pattern_add_color_stop_rgba(border_pat,0.7,1,1,1,0.6)
	cairo_pattern_add_color_stop_rgba(border_pat,1,1,1,1,0)
	...
	cairo_pattern_add_color_stop_rgba(face_pat,0,1,1,1,0.8)
	cairo_pattern_add_color_stop_rgba(face_pat,0.5,1,1,1,0.8)
	cairo_pattern_add_color_stop_rgba(face_pat,1,0.9,0.9,0.9,0.8)
