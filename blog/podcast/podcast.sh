...
echo "$SN: change to podcast root -- $ROOTB" >&2
cd "$ROOTP"
...
do
	...
	then
		...
		lowrestumbleindex=", low-res: *${lowressize[1]}* [${lowres}](/blog/podcast/${lowres})"
	fi
